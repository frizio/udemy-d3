...
// X Axis
var xAxisCall = d3.axisBottom();                                                                    // generator
var xAxis = g.append("g").attr("class", "x axis").attr("transform", "translate(0," + height + ")"); // group
var xLabel = g.append("text")                                                                       // label
...
// Y Axis
var yAxisCall = d3.axisLeft().ticks(6).tickFormat(function(d) { return parseInt(d / 1000) + "k"; });
